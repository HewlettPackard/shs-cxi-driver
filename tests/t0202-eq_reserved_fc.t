...
test_description="EQ reserved FC tests"
...
test_expect_success "Inserting eq reserved fc test driver" "
	insmod ../../../drivers/net/ethernet/hpe/ss1/tests/test-eq-reserved-fc.ko &&
	[ $(dmesg | grep -c 'Modules linked in') -eq 0 ]
"

test_expect_success "Check for errors" "
	sleep 2 &&
	[ $(dmesg | grep -c 'reserved fc tests succeeded') -eq 1 ]
"

test_expect_success "Removing eq reserved fc test driver" "
	rmmod test-eq-reserved-fc
"
